...
COS_API_KEY_ID = "75ts3w1FG_Blb6JtQVu8J0Jo86pj2-AhyqbkXjuyounA" # eg "W00YixxxxxxxxxxMB-odB-2ySfTrFBIQQWanc--P3byk"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/3836aae369644dcc8dd189a239521bf9::serviceid:ServiceId-e67ae91b-e22c-4914-95bb-da4fcabd9901"
...
@app.route('/')
def index():
    files = get_bucket_contents('magesh-ibm')
